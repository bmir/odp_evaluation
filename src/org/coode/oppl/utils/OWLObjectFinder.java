...
public class OWLObjectFinder {
	public static List<List<Integer>> findAll(OWLObject key, OWLObject container) {
		...
		List<List<Integer>> toReturn = key.equals(container) ? Collections.singletonList(Collections.singletonList(0))
...
//						if(toCompare instanceof uk.ac.manchester.cs.owl.owlapi.OWLObjectInverseOfImpl)
